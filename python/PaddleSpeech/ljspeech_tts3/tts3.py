...
def parse_args():
    ...
    parser.add_argument('--am', type=str,
                        default='fastspeech2_ljspeech',
                        help='Choose acoustic model type of tts task.')
    parser.add_argument('--am_onnx', type=str,
                        default='fastspeech2_ljspeech/fastspeech2_ljspeech.onnx')

    parser.add_argument("--phones_dict", type=str,
                        default='resources/fastspeech2_ljspeech/phone_id_map.txt',
                        help="phone vocabulary file.")

    # voc
    parser.add_argument('--voc', type=str,
                        default='pwgan_ljspeech',
                        help='Choose vocoder type of tts task.')

    parser.add_argument('--voc_onnx', type=str,
                        default='pwgan_ljspeech.onnx')
